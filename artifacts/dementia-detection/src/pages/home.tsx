...
import { Mic, Square, Languages, UserCircle, Type, Brain, Sparkles, ArrowRight, CheckCircle2, RotateCcw, ShieldAlert, HeartPulse, ClipboardCheck, Info } from 'lucide-react';
import {
  analyzeText,
  createReport,
  transcribeAudio,
...
export default function Home() {
  ...
  const translations = {
    ...
    hi: {
      ...
      heroSubtitle: 'प्रारंभिक जांच प्रणाली',
      description: 'भाषण और स्मृति पैटर्न का उपयोग करके संज्ञानात्मक जोखिम की तत्काल जांच। यह प्रणाली प्रारंभिक पहचान और दीर्घकालिक निगरानी के लिए तैयार की गई है।',
      ...
      tapStart: 'रिकॉर्डिंग शुरू करें',
      tapStop: 'रोकें और विश्लेषण करें',
      analyzeBtn: 'विश्लेषण प्रक्रिया शुरू करें',
      recallTitle: 'स्मृति सत्यापन',
      recallHelp: 'भाषण विश्लेषण तैयार है। कृपया सत्र की शुरुआत में दिए गए तीन शब्दों को याद करके लिखें।',
      seeResults: 'रिपोर्ट देखें',
      disclaimer: 'चिकित्सा सूचना: यह प्रणाली एआई-संवर्धित स्क्रीनिंग प्रदान करती है, निश्चित निदान नहीं। यह स्वास्थ्य पेशेवरों द्वारा जोखिम मूल्यांकन के लिए है।',
      medicalCard: 'जांच प्रोटोकॉल',
      privacyNote: 'सुरक्षित स्थानीय संग्रहण सक्रिय'
    }
  };
